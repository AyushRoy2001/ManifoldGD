...
OUTPUT_DATASET=results-1k/Base/$METHOD/dit-distillation-sampling-t-$T_SG/imagenet1k-$i-IPC-$IPC
TRAIN_SAVE_DIR=results-1k/Base/$METHOD/train-imagenet1k-mode-sampling-t-$T_SG/imagenet1k-$i-IPC-$IPC
