...
OUTPUT_DATASET=results-new/MGD/$METHOD/dit-distillation-sampling-t-$T_SG/imagenet100-$i-IPC-$IPC
TRAIN_SAVE_DIR=results-new/MGD/$METHOD/train-imagenet100-mode-sampling-t-$T_SG/imagenet100-$i-IPC-$IPC
